// PE course special case continuation allocation for mid exams
// Initialize lastAssignedSeatNo to 0
    ...
    const allocateSeats = (roomNo, rollNumbers) => {
        try {
            ...
            RollNumbers.forEach((studentId, index) => {
                ...
                if(allocatedRooms[currentRoom].length < 24 && index !== RollNumbers.length - 1) {
